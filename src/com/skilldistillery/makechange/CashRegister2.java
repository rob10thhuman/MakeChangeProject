...
//		BigDecimal itemPrice = kb.nextBigDecimal(); 
////		BigDecimal itemPrice2 = kb.nextBigDecimal(); 
...
//		BigDecimal amountGiven = kb.nextBigDecimal(); 
////		System.out.println(itemPrice);
//		
...
//	
//	
//	public static BigDecimal doTheMath(BigDecimal itemPrice, BigDecimal amountGiven) {
//		BigDecimal changeGiven, changeToMake; 
//		final BigDecimal penny=00.01, nickel=.05, dime=.10, quarter=.25, dollar=1.00, fiveDollar=5.00, tenDollars=10.00;
//		final BigDecimal twenty=20.00, fifty=50.00, hundred=100.00;
//		changeGiven = amountGiven.subtract(itemPrice);
